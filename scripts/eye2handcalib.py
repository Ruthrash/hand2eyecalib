...
class Eye2HandCalibration:
    def __init__(self, is_sim=True, file_name:str='calib.txt', file_location:str='/home/ruthz/') -> None:
        self.is_sim = is_sim
    ...
    def write_msgs(self,aruco_trans_msg, fiducial_det_msg, franka_state_msg):
        ...
        if(len(aruco_trans_msg.transforms) != 0 and len(fiducial_det_msg.fiducials)!= 0):
            ...
            # fiducial = [str(i) for i in[aruco_trans_msg.transforms[0].transform.translation.x, 
            #                             aruco_trans_msg.transforms[0].transform.translation.y, 
            #                             aruco_trans_msg.transforms[0].transform.translation.z, 
            #                             aruco_trans_msg.transforms[0].transform.rotation.x, 
            #                             aruco_trans_msg.transforms[0].transform.rotation.y, 
            #                             aruco_trans_msg.transforms[0].transform.rotation.z, 
            #                             aruco_trans_msg.transforms[0].transform.rotation.w,
